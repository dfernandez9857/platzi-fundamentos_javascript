...
var personasEdadEnDias9 = personas.map(p =>  p.edad );

//reduce

const reducer = (acum, { edad }) =>  acum + edad; 

var personasTotalEdad = personas.reduce(reducer, 0);
var personasTotalEdad2 = personas.reduce(function(acum,p){
    return acum + p.edad;
},0);
var personasTotalEdad3 = personas.reduce((acum,p)=>{ return acum + p.edad },0);
var personasTotalEdad4 = personas.reduce((acum, { edad })=>{ return acum + edad },0);
var personasTotalEdad5 = personas.reduce((acum, p)=> acum + p.edad , 0 );
